...
public class TransactionMapper {
	public static TransactionResponseDto toDto(Transaction trx) {

		return new TransactionResponseDto(trx.getTransactionId(), 
				...
				trx.getItems().stream()
						.map(item -> new TransactionItemResponseDto(item.getTransactionItemId(),
								item.getProduct().getProductId(), item.getProduct().getProductName(), item.getQty(),
								item.getUnitPrice(), item.getTaxAmt(),
